...
class ITComponent(models.Model):
    ...
    id = models.IntegerField(primary_key=True, default=generate_it_component_id)
...
class Team(models.Model):
    ...
    id = models.IntegerField(primary_key=True, default=generate_team_id)
...
class User(models.Model):
    """Модель пользователя"""
    id = models.IntegerField(primary_key=True, default=generate_user_id)
...
class Department(models.Model):
    ...
    id = models.IntegerField(primary_key=True, default=generate_department_id)
